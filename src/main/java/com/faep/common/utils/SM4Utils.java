...
{
    // FAEPFABJ
    private static final String key = "E3ED04183B56D3E8EE09AC6688A2EE1B";
     ...
     */
    private static byte[] generateKey() throws NoSuchProviderException, NoSuchAlgorithmException {
     ...
     * @throws Exception
     */
    private static byte[] generateKey(int keySize) throws NoSuchProviderException, NoSuchAlgorithmException {
